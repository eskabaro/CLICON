...
export const icons = {
    ...
    reload: (props: SVGProps<SVGSVGElement>) => (
    ...
    'go-back': (props: SVGProps<SVGSVGElement>) => (
        <svg width='21' height='20' viewBox='0 0 21 20' fill='none' {...props}>
    ...
    'arrow-right-2': (props: SVGProps<SVGSVGElement>) => (
        <svg width='20' height='20' viewBox='0 0 20 20' fill='none' {...props}>
            <path d='M3.125 10H16.875' stroke='white' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
            <path
